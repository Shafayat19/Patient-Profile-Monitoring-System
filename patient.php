...
<body>
    <div>
        <nav class="navbar navbar-light navbar-expand-md bg-dark navigation-clean-button">
            <div class="container-fluid"><a class="navbar-brand text-white" href="#"><i class="fa fa-globe"></i>&nbsp;PPMS</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card">
                        ...
                        <div class="card-body"><img class="rounded-circle" src ="<?php echo "img/$image";?>" style="width:150px;height:150px;margin-left:0px;">
                           ...
                           <button type="button" class="btn btn-danger"><a class="text-monospace" href="login.php" style="color:#ffffff;"><i class="fa fa-sign-out"></i>&nbsp;Logout</a></button>
                        </div>
                    </div>
                    <br>
...
mysqli_close($con);
    ...
    <div
        class="container-fluid" id="book"></div>
